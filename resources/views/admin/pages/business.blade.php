...
<div class="p-4">
    <form action="" method="post">
        ...
        <div class="grid grid-cols-1 gap-4 mt-4 md:grid-cols-3 lg:grid-cols-4">
            ...
            <x-admin-user-select name="user_id" :value="$business->user_id" label="Yönetici Kişi" /> 
        </div>
        ...
        <div class=""> 
            <x-input-tags name="tags" value="{{implode(',',$business->tags->pluck('name')->toArray())}}"  label="Etiketler" />
        </div> 
